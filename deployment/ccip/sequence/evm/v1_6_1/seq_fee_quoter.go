...
import (
	...
	ccipops "github.com/smartcontractkit/chainlink/deployment/ccip/operation/evm/v1_6_1"
...
var (
	FeeQuoterApplyDestChainConfigUpdatesSequence = operations.NewSequence(
		...
		"Apply updates to destination chain configs on the FeeQuoter 1.6.1 contract across multiple EVM chains",
